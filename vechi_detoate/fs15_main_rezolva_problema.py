...
from fs15_01_nods_edg_tri_plot import f01_load_comsol_mphtxt
...
def f04_convert_mphtxt_to_gmsh(msh_file, mphtxt_file="comsol2dfara_spire_1pe8_vechi1_3dom_403.mphtxt"):
    nodes, tris, edgs, tri_domains = f01_load_comsol_mphtxt(mphtxt_file)
    tri_domains_correct = tri_domains[4:758]
...
msh_file = "comsol2dfara_spire_1pe8_vechi1_3dom_403_manual.msh"
tri_domains_corect = f04_convert_mphtxt_to_gmsh(msh_file)
...
mu_values = {1: mu0, 2: mu_fe, 3: mu0}
j_values = {1: 0.0, 2: j0, 3: 0.0}
